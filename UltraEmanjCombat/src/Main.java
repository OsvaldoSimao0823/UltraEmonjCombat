public class Main {
    public static void main(String[] args) {
        ...
        l[1] = new Lutador("Putscript","brsil", 29, 1.68, 57.8, 14, 2, 3);
        l[2] = new Lutador("Snapshadow", "USA", 35, 1.65, 80.9,12,2,1 );
        l[3] = new Lutador("Dead Code", "Australia", 28, 1.93, 81.6, 13, 0, 2);
        l[4] = new Lutador("Osvaldo Simao", "Angola", 37, 1.70,119.3,5,4,3);
        l[5] = new Lutador("Nerdart", "Angola", 30,1.81,105.7,12,2,4);
